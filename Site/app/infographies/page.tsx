...
const INFOGRAPHICS: Infographic[] = [
  { id: '123', title: "La France d\u00e9pense plus que l'URSS", category: 'D\u00e9penses', filename: '123-france-vs-chine-urss-instagram.png' },
  ...
  { id: '148', title: 'Les Singapouriens deux fois plus riches que les Fran\u00e7ais', category: 'International', filename: '148-singapour-pib-habitant-instagram.png' },
  { id: '57', title: 'La dette augmente de 5 390 \u20ac par seconde', category: 'Dette', filename: '57-dette-5350-par-seconde-instagram.png' },
  { id: '144', title: '\u00c9volution du prix au m\u00b2 \u00e0 Paris', category: 'Immobilier', filename: '144-evolution-prix-m2-paris-instagram.png' },
  { id: '157', title: 'La France emprunte \u00e0 3,7 %, plus haut niveau depuis 15 ans', category: 'Dette', filename: '157-taux-emprunt-france-10ans-instagram.png' },
  { id: '102', title: 'Fonctionnaires pour 1 000 habitants', category: 'France', filename: '102-fonctionnaires-paris-vs-europe-instagram.png' },
  { id: '182', title: 'La France d\u00e9pense 7\u00d7 plus pour les retraites que pour la d\u00e9fense', category: 'D\u00e9penses', filename: '182-retraites-vs-defense-instagram.png' },
  { id: '178', title: 'La dette de Paris multipli\u00e9e par 9 en 25 ans', category: 'Dette', filename: '178-dette-paris-30ans-instagram.png' },
  { id: '184', title: 'La pyramide des salaires en France', category: 'Salaires', filename: '184-pyramide-salaires-france-instagram.png' },
  { id: '183', title: 'D\u00e9troit d\u2019Hormuz : o\u00f9 va le p\u00e9trole ?', category: 'International', filename: '183-detroit-hormuz-flux-petrole-instagram.png' },
  { id: '36', title: 'Fiche de paie : 3 000 \u20ac brut, combien tu re\u00e7ois ?', category: 'Salaires', filename: '36-fiche-de-paie-simple-instagram.png' },
  { id: '21', title: 'Seul un tiers des Fran\u00e7ais financent l\u2019\u00c9tat', category: 'Fiscalit\u00e9', filename: '21-qui-nourrit-etat-instagram.png' },
  { id: '18', title: 'Retraites : pas assez de monde pour les payer', category: 'D\u00e9penses', filename: '18-retraites-explosion-2070-instagram.png' },
]
