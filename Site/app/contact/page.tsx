    ...
    <div className="page-overlay">
      <div className="min-h-full flex flex-col items-center justify-center px-6 lg:px-12 py-10">
        ...
        <header className="text-center mb-10 lg:mb-12 w-full">
          ...
          <h1 className="font-serif text-[clamp(2rem,5vw,4rem)] font-normal">
            Contact & <span className="italic text-accent-gold">Partenariats</span>
          </h1>
        </header>

        {/* Options de contact */}
        <div className="flex flex-col gap-6 lg:gap-8 w-full max-w-3xl mb-10">

          {/* Questions, remarques, propositions */}
          <div className="bg-bg-surface border border-glass-border rounded-xl p-6 lg:p-8">
            <div className="flex items-start gap-4 lg:gap-6">
              <div className="w-10 h-10 flex-shrink-0 flex items-center justify-center rounded-lg bg-accent-electric/10 border border-accent-electric/20">
              ...
              <div>
                <h2 className="font-serif text-xl lg:text-2xl font-normal mb-4">
                  Questions, remarques, propositions
                </h2>
                <p className="text-text-secondary text-base lg:text-lg leading-loose">
          ...
          <div className="bg-bg-surface border border-glass-border rounded-xl p-6 lg:p-8">
            <div className="flex items-start gap-4 lg:gap-6">
              <div className="w-10 h-10 flex-shrink-0 flex items-center justify-center rounded-lg bg-accent-gold/10 border border-accent-gold/20">
              ...
              <div>
                ...
                <p className="text-text-secondary text-base lg:text-lg leading-loose mt-4">
          ...
          <div className="bg-bg-surface border border-glass-border rounded-xl p-6 lg:p-8">
            <div className="flex items-start gap-4 lg:gap-6">
              <div className="w-10 h-10 flex-shrink-0 flex items-center justify-center rounded-lg bg-accent-purple/10 border border-accent-purple/20">
        ...
        <a
          ...
          className="inline-block font-mono text-xl lg:text-2xl text-accent-electric hover:text-accent-gold transition-colors"
        >
