...
const HTML = path.join(BASE, 'Infographies', 'Sources HTML', '263-prelevements-total-france-ocde.html');
const OUT = path.join(BASE, 'Infographies', 'Insta & Autres', '263-prelevements-total-france-ocde-instagram.png');
(async () => {
