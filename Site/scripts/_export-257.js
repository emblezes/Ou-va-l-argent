...
const HTML = path.join(BASE, 'Infographies', 'Sources HTML', '257-depenses-vs-recettes-2008.html');
const OUT = path.join(BASE, 'Infographies', 'Insta & Autres', '257-depenses-vs-recettes-2008-instagram.png');
(async () => {
