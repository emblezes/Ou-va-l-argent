...
const file = '05-depenses-publiques-pib-france.html';
const slug = '05-depenses-publiques-pib-france';
...
async function run() {
  ...
  await page3.addStyleTag({ content: `.bar-value { font-size: 1.1rem !important; top: -22px !important; }` });
  await wait(500);
