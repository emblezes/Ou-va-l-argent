...
// Run the conversion
const htmlFile = process.argv[2] || '../Templates/Réseaux sociaux/template-instagram.html';
const outputDir = process.argv[3] || '/Users/emmanuelblezes/Documents/08_Où va l\'argent /Production interne/Réseaux Sociaux ';
