...
const file = '107-ouvalargent-com.html';
const slug = '107-ouvalargent-com';
...
async function run() {
  ...
  await p2.addStyleTag({ content: `
    ...
    .content { align-items: flex-start !important; padding-top: 400px !important; justify-content: center !important; }
    .url { font-size: 6.5rem !important; }
  `});
  await wait(500);
  ...
  await p3.addStyleTag({ content: `
    ...
    .url { font-size: 4.5rem !important; }
  `});
  await wait(500);
