...
const HTML = path.join(BASE, 'Infographies', 'Sources HTML', '255-solde-primaire-france-zone-euro.html');
const OUT = path.join(BASE, 'Infographies', 'Insta & Autres', '255-solde-primaire-france-zone-euro-instagram.png');
(async () => {
