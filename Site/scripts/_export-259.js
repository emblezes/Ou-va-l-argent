...
const HTML = path.join(BASE, 'Infographies', 'Sources HTML', '259-depense-publique-record-ocde.html');
const OUT = path.join(BASE, 'Infographies', 'Insta & Autres', '259-depense-publique-record-ocde-instagram.png');
(async () => {
