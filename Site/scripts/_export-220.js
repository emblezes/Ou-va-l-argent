...
const HTML = path.join(BASE, 'Infographies', 'Sources HTML', '220-charge-interets-dette-explosion.html');
const OUT = path.join(BASE, 'Infographies', 'Insta & Autres', '220-charge-interets-dette-explosion-instagram.png');
