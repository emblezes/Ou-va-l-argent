...
const HTML = path.join(BASE, 'Infographies', 'Sources HTML', '261-is-taux-legal-effectif.html');
const OUT = path.join(BASE, 'Infographies', 'Insta & Autres', '261-is-taux-legal-effectif-instagram.png');
(async () => {
