...
const file = '112-article-15-ddhc.html';
const slug = '112-article-15-ddhc';
...
async function run() {
  ...
  await p2.addStyleTag({ content: `
    ...
    .content { padding: 80px 60px 60px !important; }
    .logo-icon { font-size: 6rem !important; }
    .logo-text { font-size: 3rem !important; }
    .citation { font-size: 6.5rem !important; }
    .reference { font-size: 1.6rem !important; }
    .website { font-size: 2.2rem !important; }
  `});
  await wait(500);
  ...
  await p3.addStyleTag({ content: `
    ...
    .citation { font-size: 2.8rem !important; }
    .reference { font-size: 0.9rem !important; }
    .website { font-size: 1.4rem !important; }
  `});
  await wait(500);
