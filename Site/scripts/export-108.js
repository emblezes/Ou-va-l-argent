...
const file = '108-logo-euro.html';
const slug = '108-logo-euro';
...
async function run() {
  ...
  await p2.addStyleTag({ content: `
    ...
    .content { align-items: center !important; padding-top: 250px !important; justify-content: flex-start !important; }
    .euro { font-size: 34rem !important; }
  `});
  await wait(500);
  ...
  await p3.addStyleTag({ content: `
    ...
    .euro { font-size: 18rem !important; }
  `});
  await wait(500);
