...
const HTML = path.join(BASE, 'Infographies', 'Sources HTML', '264-patrimoine-financier-menages.html');
const OUT = path.join(BASE, 'Infographies', 'Insta & Autres', '264-patrimoine-financier-menages-instagram.png');
(async () => {
