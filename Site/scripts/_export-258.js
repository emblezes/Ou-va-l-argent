...
const HTML = path.join(BASE, 'Infographies', 'Sources HTML', '258-postes-depense-gonfle-2000.html');
const OUT = path.join(BASE, 'Infographies', 'Insta & Autres', '258-postes-depense-gonfle-2000-instagram.png');
(async () => {
