...
const HTML = path.join(BASE, 'Infographies', 'Sources HTML', '260-ecart-fiscal-france-ocde.html');
const OUT = path.join(BASE, 'Infographies', 'Insta & Autres', '260-ecart-fiscal-france-ocde-instagram.png');
(async () => {
