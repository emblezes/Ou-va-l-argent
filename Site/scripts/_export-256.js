...
const HTML = path.join(BASE, 'Infographies', 'Sources HTML', '256-ecart-depense-france-zone-euro.html');
const OUT = path.join(BASE, 'Infographies', 'Insta & Autres', '256-ecart-depense-france-zone-euro-instagram.png');
(async () => {
